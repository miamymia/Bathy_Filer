...
# Usage: python Create_dirs.py path startwith notstartswith
# Example: python Create_dirs.py /Volumes/Bathy/Data/01_EEZ_checked/ M MSM
...
def create_dirs(cruise_name):
    ...
    cov_path = os.path.join(product_path, '_cov')
