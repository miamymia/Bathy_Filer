...
- **Note**: If names are misspelled, these datasets will be marked as missing! Most common mistake: Cruise leg names should ALWAYS be written like e.g. SO301-1, and NOT(!) SO308_1. Currently, there is no check for such spelling mistakes hence if wrong, the respective datasets will be marked as missing which has to be corrected manually.
